...
// Returns the private 'App\Repository\CommenterRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CommenterRepository.php';

return $this->privates['App\Repository\CommenterRepository'] = new \App\Repository\CommenterRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
