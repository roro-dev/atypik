...
// Returns the private 'App\Repository\ActviteLogementRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ActviteLogementRepository.php';

return $this->privates['App\Repository\ActviteLogementRepository'] = new \App\Repository\ActviteLogementRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
