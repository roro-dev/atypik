...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\ActiviteRepository' => function () {
    return ($this->privates['App\Repository\ActiviteRepository'] ?? $this->load('getActiviteRepositoryService.php'));
}, 'App\\Repository\\ActviteLogementRepository' => function () {
    return ($this->privates['App\Repository\ActviteLogementRepository'] ?? $this->load('getActviteLogementRepositoryService.php'));
    ...
    return ($this->privates['App\Repository\PhotoRepository'] ?? $this->load('getPhotoRepositoryService.php'));
...
}, 'App\\Repository\\VilleRepository' => function () {
    return ($this->privates['App\Repository\VilleRepository'] ?? $this->load('getVilleRepositoryService.php'));
}))));
