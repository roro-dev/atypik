...
<form action=\"";
        // line 8
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("login_route");
        echo "\" method=\"post\">
...
<form action=\"{{ path('login_route') }}\" method=\"post\">
    ...
    <button type=\"submit\">login</button>
</form>", "security/login.html.twig", "C:\\Users\\stefane.rodrigues\\Documents\\my-project\\templates\\security\\login.html.twig");
    }
}
