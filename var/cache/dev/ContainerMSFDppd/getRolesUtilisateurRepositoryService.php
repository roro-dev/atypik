...
// Returns the private 'App\Repository\RolesUtilisateurRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\RolesUtilisateurRepository.php';

return $this->privates['App\Repository\RolesUtilisateurRepository'] = new \App\Repository\RolesUtilisateurRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
