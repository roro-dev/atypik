...
// Returns the private 'App\Repository\TypePaiementRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TypePaiementRepository.php';

return $this->privates['App\Repository\TypePaiementRepository'] = new \App\Repository\TypePaiementRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
